...
![线性回归](https://i.loli.net/2019/05/05/5cce9fec300f6.jpg)
...
![决策边界](https://i.loli.net/2019/05/05/5cce9ffec90eb.jpg)
...
![非线性决策边界](https://i.loli.net/2019/05/05/5ccea015a8e24.jpg)
...
![成本函数图像1](https://i.loli.net/2019/05/05/5ccea023069d0.jpg)

此时，当$\hat{y}=1$时损失为$0$，而$\hat{y} \to 0$时，成本趋近$\infty$。

反之，当$y = 0$时，函数图像为：

![成本函数图像2](https://i.loli.net/2019/05/05/5ccea02e277a7.jpg)
...
![猫图分类器](https://i.loli.net/2019/05/05/5cce9c330a904.jpg)
